[![Build Status](https://travis-ci.org/bitpay/cordova-plugin-qrscanner-rm.svg?branch=master)](https://travis-ci.org/bitpay/cordova-plugin-qrscanner-rm) [![npm](https://img.shields.io/npm/v/cordova-plugin-qrscanner-rm.svg)](https://www.npmjs.com/package/cordova-plugin-qrscanner-rm) [![npm](https://img.shields.io/npm/dm/cordova-plugin-qrscanner-rm.svg)](https://www.npmjs.com/package/cordova-plugin-qrscanner-rm)
[![Dependency Status](https://david-dm.org/bitpay/cordova-plugin-qrscanner-rm.svg)](https://david-dm.org/bitpay/cordova-plugin-qrscanner-rm)
[![Commitizen friendly](https://img.shields.io/badge/commitizen-friendly-brightgreen.svg)](http://commitizen.github.io/cz-cli/)

# cordova-plugin-qrscanner-rm
...
<!-- Does your project use cordova-plugin-qrscanner-rm? We'd love to share a screenshot of your scanning interface! Please send a pull request adding your screenshot to the list below. -->
...
```bash
cordova plugin add cordova-plugin-qrscanner-rm
```
...
There are two primary steps to integrating `cordova-plugin-qrscanner-rm`.
...
Because of API limitations, `status.restricted` will always be false on the Android platform. See [#15](https://github.com/bitpay/cordova-plugin-qrscanner-rm/issues/15) for details. Pull requests welcome!
...
## Typescript
Type definitions for cordova-plugin-qrscanner-rm are [available in the DefinitelyTyped project](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/cordova-plugin-qrscanner-rm/cordova-plugin-qrscanner-rm.d.ts).
...
This will create a new cordova project in the `cordova-plugin-test-projects` directory next to this repo, install `cordova-plugin-qrscanner-rm`, and configure the [Cordova Plugin Test Framework](https://github.com/apache/cordova-plugin-test-framework). Once the platform tests are generated, the following commands are available:
